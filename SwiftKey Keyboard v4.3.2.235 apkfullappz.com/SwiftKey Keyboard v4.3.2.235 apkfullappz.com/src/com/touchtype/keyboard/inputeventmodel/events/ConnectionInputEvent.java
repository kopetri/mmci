...
public abstract class ConnectionInputEvent
{
  ...
  public ConnectionInputEvent markAsInsertingCandidate(Candidate paramCandidate)
  {
    this.mInsertingPrediction = paramCandidate;
    return this;
  }
 ...
 * Qualified Name:     com.touchtype.keyboard.inputeventmodel.events.ConnectionInputEvent

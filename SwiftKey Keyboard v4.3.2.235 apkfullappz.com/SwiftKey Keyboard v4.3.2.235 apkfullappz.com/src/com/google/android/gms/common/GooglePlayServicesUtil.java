...
public final class GooglePlayServicesUtil
{
  ...
  public static int isGooglePlayServicesAvailable(Context paramContext)
  {
    ...
    if (localPackageInfo2.versionCode < 3159100)
    {
      Log.w("GooglePlayServicesUtil", "Google Play services out of date.  Requires 3159100 but found " + localPackageInfo2.versionCode);
      return 2;
    }
    try
    {

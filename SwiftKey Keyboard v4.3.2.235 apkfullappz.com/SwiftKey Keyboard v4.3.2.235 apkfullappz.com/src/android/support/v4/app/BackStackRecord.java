    ...
    for (;;)
    {
      ...
      for (Op localOp = this.mHead; localOp != null; localOp = localOp.next)
      {
        if (localOp.fragment != null)
        {
          ...
          if (FragmentManagerImpl.DEBUG) {
            new StringBuilder("Bump nesting of ").append(localOp.fragment).append(" to ").append(localOp.fragment.mBackStackNesting).toString();
          }
        }
      ...
      for (;;)
      {
        ...
        if (this.mManager.mAdded != null)
        {
          ...
          if (i < this.mManager.mAdded.size())
          {
            ...
            if (FragmentManagerImpl.DEBUG) {
              new StringBuilder("OP_REPLACE: adding=").append(localFragment6).append(" old=").append(localFragment7).toString();
            }
            ...
            for (;;)
            {
              ...
              if (this.mAddToBackStack)
              {
                ...
                if (FragmentManagerImpl.DEBUG) {
                  new StringBuilder("Bump nesting of ").append(localFragment7).append(" to ").append(localFragment7.mBackStackNesting).toString();
                }
              }

  ...
  protected void onPageScrolled(int paramInt1, float paramFloat, int paramInt2)
  {
    if (this.mDecorChildCount > 0)
    {
      ...
      if (i3 < i2)
      {
        ...
        for (;;)
        {
          int i5 = i4 + k - localView2.getLeft();
          if (i5 != 0) {
            localView2.offsetLeftAndRight(i5);
          }
          i3++;
          break;
          i4 = m;
          ...
          continue;
          i4 = Math.max((i1 - localView2.getMeasuredWidth()) / 2, m);
          continue;
          i4 = i1 - n - localView2.getMeasuredWidth();
        ...
        if (localObject1 != null)
        {
          ...
          if (i7 >= 0)
          {
            ...
            if ((i9 == i20) && (!localItemInfo5.scrolling))
            {
              ...
              PagerAdapter localPagerAdapter2 = this.mAdapter;
              Object localObject3 = localItemInfo5.object;
          ...
          for (ItemInfo localItemInfo5 = (ItemInfo)this.mItems.get(i7);; localItemInfo5 = null)
          {
            i9--;
            break label398;
            label509:
          ...
          if (f3 < 2.0F)
          {
            ...
            if (i10 < i11)
            {
              ...
              if ((i12 == i16) && (!localItemInfo6.scrolling))
              {
                ...
                PagerAdapter localPagerAdapter1 = this.mAdapter;
                Object localObject2 = localItemInfo6.object;
                localPagerAdapter1.destroyItem(this, i12, localObject2);
            ...
            for (ItemInfo localItemInfo6 = (ItemInfo)this.mItems.get(i10);; localItemInfo6 = null)
            {
              i12++;
              break label728;
              localItemInfo6 = null;

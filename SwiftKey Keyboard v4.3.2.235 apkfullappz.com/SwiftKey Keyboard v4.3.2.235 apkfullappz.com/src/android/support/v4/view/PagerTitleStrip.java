  ...
  implements ViewPager.Decor
{
  ...
  void updateTextPositions(int paramInt, float paramFloat, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      int i27 = i26 + i;
      int i28 = i23 + this.mPrevText.getMeasuredHeight();
      localTextView1.layout(i26, i23, i27, i28);
      int i29 = Math.max(n - i3 - k, i10 + this.mScaledTextSpacing);
      TextView localTextView2 = this.mNextText;
      int i30 = i29 + k;
      int i31 = i25 + this.mNextText.getMeasuredHeight();
      localTextView2.layout(i29, i25, i30, i31);

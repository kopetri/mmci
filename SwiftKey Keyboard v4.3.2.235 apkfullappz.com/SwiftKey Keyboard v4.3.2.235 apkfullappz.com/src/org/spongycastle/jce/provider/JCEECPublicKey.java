  ...
  implements java.security.interfaces.ECPublicKey, ECPointEncoder, org.spongycastle.jce.interfaces.ECPublicKey
{
  ...
  public JCEECPublicKey(String paramString, ECPublicKeyParameters paramECPublicKeyParameters, org.spongycastle.jce.spec.ECParameterSpec paramECParameterSpec)
  {
    ECDomainParameters localECDomainParameters = paramECPublicKeyParameters.getParameters();
    this.algorithm = paramString;
    this.q = paramECPublicKeyParameters.getQ();
  ...
  public JCEECPublicKey(String paramString, org.spongycastle.jce.spec.ECPublicKeySpec paramECPublicKeySpec)
  {
    this.algorithm = paramString;
  ...
  private void populateFromPubKeyInfo(SubjectPublicKeyInfo paramSubjectPublicKeyInfo)
  {
    ...
    X962Parameters localX962Parameters = new X962Parameters((ASN1Primitive)paramSubjectPublicKeyInfo.getAlgorithmId().getParameters());

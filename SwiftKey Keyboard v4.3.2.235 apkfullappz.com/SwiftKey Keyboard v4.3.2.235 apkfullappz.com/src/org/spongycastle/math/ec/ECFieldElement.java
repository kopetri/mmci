  ...
  implements ECConstants
{
    ...
    extends ECFieldElement
  {
    ...
    public ECFieldElement invert()
    {
      ...
      while (!((IntArray)localObject1).isZero())
      {
    ...
    extends ECFieldElement
  {
    ...
    private static BigInteger[] lucasSequence(BigInteger paramBigInteger1, BigInteger paramBigInteger2, BigInteger paramBigInteger3, BigInteger paramBigInteger4)
    {
      ...
      BigInteger localBigInteger8 = localBigInteger1.multiply(localBigInteger2).subtract(localBigInteger6).mod(paramBigInteger1);
      BigInteger localBigInteger9 = localBigInteger3.multiply(localBigInteger2).subtract(paramBigInteger2.multiply(localBigInteger6)).mod(paramBigInteger1);
      BigInteger localBigInteger10 = localBigInteger6.multiply(localBigInteger7).mod(paramBigInteger1);
      for (int m = 1; m <= j; m++)
      {

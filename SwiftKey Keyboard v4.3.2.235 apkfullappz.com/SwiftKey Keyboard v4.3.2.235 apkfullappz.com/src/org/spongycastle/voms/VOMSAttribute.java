...
public class VOMSAttribute
{
  ...
  public VOMSAttribute(X509AttributeCertificate paramX509AttributeCertificate)
  {
    ...
    for (int i = 0;; i++)
    {
      ...
      try
      {
        ...
        localIetfAttrSyntax = IetfAttrSyntax.getInstance(arrayOfX509Attribute[i].getValues()[0]);
        str1 = ((DERIA5String)localIetfAttrSyntax.getPolicyAuthority().getNames()[0].getName()).getString();
        j = str1.indexOf("://");
  ...
  public class FQAN
  {
    ...
    public String getFQAN()
    {
      ...
      StringBuilder localStringBuilder1 = new StringBuilder().append(this.group).append("/Role=");
      String str1;
      ...
      label102:
      for (String str2 = "/Capability=" + this.capability;; str2 = "")
      {
        this.fqan = str2;
        return this.fqan;
        str1 = "";
    ...
    protected void split()
    {
      ...
      label131:
      for (String str2 = null;; str2 = this.fqan.substring(j + 12))
      {
 ...
 * Qualified Name:     org.spongycastle.voms.VOMSAttribute

  ...
  implements DigestAlgorithmIdentifierFinder
{
  ...
  public AlgorithmIdentifier find(AlgorithmIdentifier paramAlgorithmIdentifier)
  {
    if (paramAlgorithmIdentifier.getAlgorithm().equals(PKCSObjectIdentifiers.id_RSASSA_PSS)) {
      return ((RSASSAPSSparams)paramAlgorithmIdentifier.getParameters()).getHashAlgorithm();
    }
    return new AlgorithmIdentifier((ASN1ObjectIdentifier)digestOids.get(paramAlgorithmIdentifier.getAlgorithm()), new DERNull());
  }
}


/* Location:           C:\Users\sebastian\Mobile Mensch Computer Interaktion\02\SwiftKey Keyboard v4.3.2.235 apkfullappz.com\SwiftKey Keyboard v4.3.2.235 apkfullappz.com\dex2jar-0.0.9.15\classes-dex2jar.jar
 * Qualified Name:     org.spongycastle.operator.DefaultDigestAlgorithmIdentifierFinder

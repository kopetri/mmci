...
public class SECNamedCurves
{
  ...
  static X9ECParametersHolder secp160k1 = new X9ECParametersHolder()
  {
    protected X9ECParameters createParameters()
    {
      ...
      BigInteger localBigInteger5 = BigInteger.valueOf(1L);
      ECCurve.Fp localFp = new ECCurve.Fp(localBigInteger1, localBigInteger2, localBigInteger3);
      return new X9ECParameters(localFp, localFp.decodePoint(Hex.decode("043B4C382CE37AA192A4019E763036F4F5DD4D7EBB938CF935318FDCED6BC28286531733C3F03C4FEE")), localBigInteger4, localBigInteger5, null);
    }
  };
  ...
  static X9ECParametersHolder secp192k1 = new X9ECParametersHolder()
  {
    protected X9ECParameters createParameters()
    {
      ...
      BigInteger localBigInteger5 = BigInteger.valueOf(1L);
      ECCurve.Fp localFp = new ECCurve.Fp(localBigInteger1, localBigInteger2, localBigInteger3);
      return new X9ECParameters(localFp, localFp.decodePoint(Hex.decode("04DB4FF10EC057E9AE26B07D0280B7F4341DA5D1B1EAE06C7D9B2F2F6D9C5628A7844163D015BE86344082AA88D95E2F9D")), localBigInteger4, localBigInteger5, null);
    }
  };
  ...
  static X9ECParametersHolder secp224k1 = new X9ECParametersHolder()
  {
    protected X9ECParameters createParameters()
    {
      ...
      BigInteger localBigInteger5 = BigInteger.valueOf(1L);
      ECCurve.Fp localFp = new ECCurve.Fp(localBigInteger1, localBigInteger2, localBigInteger3);
      return new X9ECParameters(localFp, localFp.decodePoint(Hex.decode("04A1455B334DF099DF30FC28A169A467E9E47075A90F7E650EB6B7A45C7E089FED7FBA344282CAFBD6F7E319F7C0B0BD59E2CA4BDB556D61A5")), localBigInteger4, localBigInteger5, null);
    }
  };
  ...
  static X9ECParametersHolder secp256k1 = new X9ECParametersHolder()
  {
    protected X9ECParameters createParameters()
    {
      ...
      BigInteger localBigInteger5 = BigInteger.valueOf(1L);
      ECCurve.Fp localFp = new ECCurve.Fp(localBigInteger1, localBigInteger2, localBigInteger3);
      return new X9ECParameters(localFp, localFp.decodePoint(Hex.decode("0479BE667EF9DCBBAC55A06295CE870B07029BFCDB2DCE28D959F2815B16F81798483ADA7726A3C4655DA4FBFC0E1108A8FD17B448A68554199C47D08FFB10D4B8")), localBigInteger4, localBigInteger5, null);
    }
  };
  ...
  static X9ECParametersHolder sect163k1 = new X9ECParametersHolder()
  {
    protected X9ECParameters createParameters()
    {
      ...
      return new X9ECParameters(localF2m, localF2m.decodePoint(Hex.decode("0402FE13C0537BBC11ACAA07D793DE4E6D5E5C94EEE80289070FB05D38FF58321F2E800536D538CCDAA3D9")), localBigInteger3, localBigInteger4, null);
    }
  };
  ...
  static X9ECParametersHolder sect233k1 = new X9ECParametersHolder()
  {
    protected X9ECParameters createParameters()
    {
      ...
      return new X9ECParameters(localF2m, localF2m.decodePoint(Hex.decode("04017232BA853A7E731AF129F22FF4149563A419C26BF50A4C9D6EEFAD612601DB537DECE819B7F70F555A67C427A8CD9BF18AEB9B56E0C11056FAE6A3")), localBigInteger3, localBigInteger4, null);
    }
  };
  ...
  static X9ECParametersHolder sect239k1 = new X9ECParametersHolder()
  {
    protected X9ECParameters createParameters()
    {
      ...
      return new X9ECParameters(localF2m, localF2m.decodePoint(Hex.decode("0429A0B6A887A983E9730988A68727A8B2D126C44CC2CC7B2A6555193035DC76310804F12E549BDB011C103089E73510ACB275FC312A5DC6B76553F0CA")), localBigInteger3, localBigInteger4, null);
    }
  };
  static X9ECParametersHolder sect283k1 = new X9ECParametersHolder()
  {
    protected X9ECParameters createParameters()
    {
      ...
      return new X9ECParameters(localF2m, localF2m.decodePoint(Hex.decode("040503213F78CA44883F1A3B8162F188E553CD265F23C1567A16876913B0C2AC245849283601CCDA380F1C9E318D90F95D07E5426FE87E45C0E8184698E45962364E34116177DD2259")), localBigInteger3, localBigInteger4, null);
    }
  };
  ...
  {
    ASN1ObjectIdentifier localASN1ObjectIdentifier = (ASN1ObjectIdentifier)objIds.get(Strings.toLowerCase(paramString));
  ...
  {
    X9ECParametersHolder localX9ECParametersHolder = (X9ECParametersHolder)curves.get(paramASN1ObjectIdentifier);

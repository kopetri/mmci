...
class X509Util
{
    ...
    throws IOException, NoSuchProviderException, NoSuchAlgorithmException, InvalidKeyException, SignatureException
  {
    ...
    for (;;)
    {
      localSignature.update(paramASN1Encodable.toASN1Primitive().getEncoded("DER"));
  ...
  {
    String str1;
    for (localObject1 = Strings.toUpperCase(paramString2);; localObject1 = str1)
    {
  ...
  static AlgorithmIdentifier getSigAlgID(DERObjectIdentifier paramDERObjectIdentifier, String paramString)
  {
    ...
    if (params.containsKey(str)) {
      return new AlgorithmIdentifier(paramDERObjectIdentifier, (ASN1Encodable)params.get(str));
    }

...
public class RIPEMD160
{
    ...
    extends DigestAlgorithmProvider
  {
    ...
    {
      paramConfigurableProvider.addAlgorithm("MessageDigest.RIPEMD160", PREFIX + "$Digest");
      paramConfigurableProvider.addAlgorithm("Alg.Alias.MessageDigest." + TeleTrusTObjectIdentifiers.ripemd160, "RIPEMD160");
      addHMACAlgorithm(paramConfigurableProvider, "RIPEMD160", PREFIX + "$HashMac", PREFIX + "$KeyGenerator");

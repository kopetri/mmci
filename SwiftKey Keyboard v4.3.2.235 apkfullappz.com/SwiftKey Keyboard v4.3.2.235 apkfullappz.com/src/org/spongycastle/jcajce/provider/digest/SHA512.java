...
public class SHA512
{
    ...
    extends DigestAlgorithmProvider
  {
    ...
    {
      paramConfigurableProvider.addAlgorithm("MessageDigest.SHA-512", PREFIX + "$Digest");
      paramConfigurableProvider.addAlgorithm("Alg.Alias.MessageDigest.SHA512", "SHA-512");
      paramConfigurableProvider.addAlgorithm("Alg.Alias.MessageDigest." + NISTObjectIdentifiers.id_sha512, "SHA-512");
      addHMACAlgorithm(paramConfigurableProvider, "SHA512", PREFIX + "$HashMac", PREFIX + "$KeyGenerator");

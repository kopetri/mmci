...
public final class Noekeon
{
    ...
    extends AlgorithmProvider
  {
    ...
    {
      paramConfigurableProvider.addAlgorithm("AlgorithmParameters.NOEKEON", PREFIX + "$AlgParams");
      paramConfigurableProvider.addAlgorithm("AlgorithmParameterGenerator.NOEKEON", PREFIX + "$AlgParamGen");
      paramConfigurableProvider.addAlgorithm("Cipher.NOEKEON", PREFIX + "$ECB");
      paramConfigurableProvider.addAlgorithm("KeyGenerator.NOEKEON", PREFIX + "$KeyGen");
    }
  }
}

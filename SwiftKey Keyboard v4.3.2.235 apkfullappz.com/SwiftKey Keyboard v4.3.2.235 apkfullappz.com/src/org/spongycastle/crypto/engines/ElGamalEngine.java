  ...
  implements AsymmetricBlockCipher
{
  ...
  public byte[] processBlock(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    for (BigInteger localBigInteger3 = new BigInteger(j, this.random); (localBigInteger3.equals(ZERO)) || (localBigInteger3.compareTo(localBigInteger1.subtract(TWO)) > 0); localBigInteger3 = new BigInteger(j, this.random)) {}
    ...
    while (arrayOfByte3.length > arrayOfByte4.length / 2)
    {

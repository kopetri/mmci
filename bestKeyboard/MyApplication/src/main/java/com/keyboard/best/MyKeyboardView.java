...
public class MyKeyboardView extends RelativeLayout {
    ...
    private Button mbtn_space;
    private Button mbtn_shift;
    ...
    protected void onFinishInflate() {
        mbtn_shift = (Button) findViewById(R.id.btn_shift);
        ...
        mbtn_shift.setOnClickListener(mButtonClickListener);

        mbtn_space = (Button) findViewById(R.id.btn_space);
        ...
        mbtn_space.setOnClickListener(mButtonClickListener);
    }
